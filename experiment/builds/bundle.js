...
var init_extensions = __esm(() => {
  ...
  Promise.prototype.asLazyComponent = function(member) {
    if (!member || member.endsWith("$"))
      member = "default";
    const base = this;
    const none = import_react.default.createElement("div");
    ...
    if (IS_SERVER_SIDE3)
      ...
      return function(props) {
        ...
        const [child, setComponent] = import_react.default.useState(none);
        import_react.default.useEffect(() => base.then(afterImported), []);
        function afterImported(imported) {
          if (!imported[member])
            throws(fail2, import.meta);
...
var import_react3, default$, CountButton, counter_default;
var init_counter = __esm(() => {
  import_react3 = __toESM(require_react(), 1);
  init_npm3();
  default$ = seo2("Counter", "...")(import.meta, (props) => import_react3.default.createElement(import_react3.default.Fragment, null, import_react3.default.createElement("h1", null, "Counter"), import_react3.default.createElement(CountButton, null), import_react3.default.createElement("h6", {
    shown: false
  }, "DONT SHOW ME!")));
...
var import_react4, modeValidate, onSubmit, default$2, form_default;
var init_form2 = __esm(() => {
  ...
  default$2 = client(true)(import.meta, (props, { fails: errors, await: awaits }) => import_react4.default.createElement(import_react4.default.Fragment, null, import_react4.default.createElement("h1", null, "Uncontrolled Components"), import_react4.default.createElement("progress", {
    hidden: !awaits
...
var import_react7, default$3, login_default;
var init_login = __esm(() => {
  import_react7 = __toESM(require_react(), 1);
  init_npm3();
  default$3 = client(true)(import.meta, (props, feeds) => import_react7.default.createElement(import_react7.default.Fragment, null, import_react7.default.createElement("h1", null, "Login"), import_react7.default.createElement("progress", {
    hidden: !feeds.await
