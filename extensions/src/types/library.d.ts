...
declare interface IParser<T=RRE, TTs=T[]> {
      root: RRE
      path: string
      href: string   
...
declare interface SyncParser extends IParser<RRE, RRE|RRE[]> { }

declare interface AsyncParser extends IParser<Async<RRE>, Async<RRE|RRE[]>> { }
...
declare interface OrbitalBinding  {  
   count: number
